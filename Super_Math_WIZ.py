...
print("Welcome to Super Math WIZ!")
print('')
print('')
print("Enter three numbers, and it will calculate the sum, average, and show the highest nuymber entered!")
...
print('')
print("I hope you enjoyed using Super Math WIZ!")
